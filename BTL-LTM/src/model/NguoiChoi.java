 ...
 * @author Okami
 */
public class NguoiChoi implements Serializable, Comparable<NguoiChoi> {
    ...
    public NguoiChoi(int id, String username, String fullName, int userStatus, int win, int draw, int lose) {
        this.id = id;
        this.username = username;
        this.fullName = fullName;
        this.userStatus = userStatus;
    ...
    @Override
    public int compareTo(NguoiChoi nguoiChoi) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        return ((this.win > nguoiChoi.win) ? -1 : ((this.win == nguoiChoi.win) ? 0 : 1));
    }
}
